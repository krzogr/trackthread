...
/**
 * Visitor which performs the instrumentation of thread subclasses (classes extending from {@code java.lang.Thread}).
 */
public class ThreadSubclassVisitor extends ClassVisitor {
  public ThreadSubclassVisitor(final int api, final ClassVisitor cv) {
    super(api, cv);
  }
